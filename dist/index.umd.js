(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('qiniu-js'), require('crypto')) :
  typeof define === 'function' && define.amd ? define(['qiniu-js', 'crypto'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Qiniu = factory(global.qiniu, global.crypto));
})(this, (function (qiniu, crypto) { 'use strict';
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log('configComplete', _this2.configComplete);
                    _context2.next = 3;
                  ...
                  case 3:
                    ...
                    if (result) {
                      ...
                      observable = qiniu__namespace.upload(file, key, opts === null || opts === void 0 ? void 0 : opts.token, (_this2$opts = _this2.opts) === null || _this2$opts === void 0 ? void 0 : _this2$opts.putExtra, opts === null || opts === void 0 ? void 0 : opts.config);
